...
defaults write com.apple.TelephonyUtilities "GondolaGeneratedIdentifier" -string '3B0E0C03-02B0-4394-A722-520F2512AB3C'
defaults write com.apple.TelephonyUtilities "GondolaLastAccountsChangedState" -boolean true
defaults write com.apple.TelephonyUtilities "GondolaLatestVersion" -integer 2
defaults write com.apple.TelephonyUtilities "GondolaSyncedVersion" -integer 0
