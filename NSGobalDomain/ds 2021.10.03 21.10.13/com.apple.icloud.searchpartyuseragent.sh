...
'
defaults write com.apple.icloud.searchpartyuseragent "CKStartupTime" -integer 1633248962
...
<dict>
	...
	bnRpYWxzViRjbGFzcxABEAMQPwmAAtIZGhscWiRjbGFzc25hbWVYJGNsYXNz
...
defaults write com.apple.icloud.searchpartyuseragent "LastOSLaunchVersion" -string '21A5534d'
defaults write com.apple.icloud.searchpartyuseragent "PayloadCacheMarkedPurgeable" -boolean true
...
defaults write com.apple.icloud.searchpartyuseragent "lastLaunchBootSessionUUID" -string '5B38C285-ADCB-4E51-B79E-64921DF780B1'
