...
'
defaults write com.apple.cloudpaird "CKStartupTime" -integer 1633210384
...
'
defaults write com.apple.cloudpaird "MagicCloudPairingAccessorySubscriptionID" -string '584C7B07-FA73-445B-99E1-3FE74822487F'
defaults write com.apple.cloudpaird "MagicCloudPairingMasterSubscriptionID" -string '825EE51C-6FA8-47C8-A620-A591EE32A487'
